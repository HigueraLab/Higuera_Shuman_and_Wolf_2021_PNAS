#Code to conduct contemporary fire spatial analyses for Higuera, Shuman, & Wolf (2021) PNAS
#
#
#Data files needed:
#
...
#       And is further limited to the broad ESP_LF classifications of Wetland Forest, Upland Forest, Upland Woodland
#
...
#Read in vegetation data - a 30x30 m raster with non-zero values for LANDFIRE ESP subalpine forest types and NA for all other veg types
...
#Calculating fire area and FRP for M331H and M331I ecoregion------------------------------------------------------------------------
...
fire.byveg$Polygon_area_ha = fires$area_ha #for each fire polygon, calculate the area in ha
...
fire.byveg.clp$Polygon_area_ha = fires.clp$area_ha #for each fire polygon, calculate the area in ha
...
#install.packages("dplyr") #install package if needed
library(dplyr)
